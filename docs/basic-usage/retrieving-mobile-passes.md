...
Once a pass is associated with one of your models (see [Generating your first pass](basic-usage/generating-your-first-pass) for how to wire that up), the `HasMobilePasses` trait gives you a few ways to fetch them back.
